            ...
            <div class="wizard-form">
                <table class="table table-striped">
                    ...
                    <?php $__currentLoopData = $pr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($info['textilesMinistryFileStatus'] == 'pickedtom'): ?>
                            <tr>
...
<?php echo $__env->make("Ministry.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\One_Stop_Service_Points\resources\views/Ministry/pickedproject.blade.php ENDPATH**/ ?>