...
<body>
<!-- header -->
<?php echo $__env->make("Ministry.header", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="wizard-v1-content">
            <div class="wizard-form">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <tr>
                        <?php if($pr['textilesMinistryFileStatus'] == 'processingtom' && session('ministryEmail')=='jute@gmail.com'): ?>
                            ...
                            <td> <a href="/ministryUpdateTextilesMinistryFileStatus/<?php echo e($pr['id']); ?>" class="btn btn--green">Confirm</a></td>
                        <?php endif; ?>
                    </tr>
                    <tr>
                        <?php if($pr['environmentMinistryFileStatus'] == 'processingtoe' && session('ministryEmail')=='forest@gmail.com'): ?>
                    ...
                    <tr>
                        <?php if($pr['foreignMinistryFileStatus'] == 'processingtof' && session('ministryEmail')=='ferign@gmail.com'): ?>
                    ...
                    <tr>
                        <?php if($pr['planningMinistryFileStatus'] == 'processingtop' && session('ministryEmail')=='planning@gmail.com'): ?>
...
<?php /**PATH C:\xampp\htdocs\laravel\One_Stop_Service_Points\resources\views/Ministry/openproject.blade.php ENDPATH**/ ?>