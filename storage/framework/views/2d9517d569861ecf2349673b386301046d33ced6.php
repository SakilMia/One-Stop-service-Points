                        ...
                        <div class="login-wrap">
                            <div class="login-content">
                                ...
                                <div class="login-form">
                                    <form action="/updateMinistry/<?php echo e($mi['id']); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="au-input au-input--full" type="email" name="email" value="<?php echo e($mi['email']); ?>" placeholder="Email">
                                        </div>
                                        <div class="form-group">
                                            <label>Password</label>
                                            <input class="au-input au-input--full" type="password" name="password" value="<?php echo e($mi['password']); ?>" placeholder="Password">
                                        </div>
...
<!-- end document-->
<?php /**PATH C:\xampp\htdocs\laravel\One_Stop_Service_Points\resources\views/Admin/editministry.blade.php ENDPATH**/ ?>