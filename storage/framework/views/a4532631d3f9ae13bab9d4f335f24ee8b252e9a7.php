                        ...
                        <div class="login-wrap">
                            <div class="login-content">
                                ...
                                <div class="login-form">
                                    <form action="/editinfo/<?php echo e($em['id']); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                                        <?php echo e(method_field('PUT')); ?>

                                        <div class="form-group">
                                            <label>Username</label>
                                            <input class="au-input au-input--full" type="text" name="username" value="<?php echo e($em['username']); ?>" placeholder="Username">
                                        </div>
                                        <div class="form-group">
                                            <label>Email Address</label>
                                            <input class="au-input au-input--full" type="email" name="email" value="<?php echo e($em['email']); ?>" placeholder="Email">
                                        </div>
                                        <div class="form-group">
                                            <label>Password</label>
                                            <input class="au-input au-input--full" type="password" name="password" value="<?php echo e($em['password']); ?>" placeholder="Password">
                                        </div>
...
<!-- end document-->
<?php /**PATH C:\xampp\htdocs\laravel\One_Stop_Service_Points\resources\views/Admin/editemployee.blade.php ENDPATH**/ ?>